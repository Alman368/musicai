...
from dataset.e_piano import compute_epiano_accuracy, create_epiano_datasets
from model.loss import SmoothCrossEntropyLoss
from model.music_transformer import MusicTransformer
from torch.optim import Adam
from torch.optim.lr_scheduler import LambdaLR
from torch.utils.data import DataLoader
from utilities.argument_funcs import (
    parse_train_args,
    print_train_args,
    write_model_params,
)
...
from utilities.run_model import eval_model, train_epoch
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print("Avg train ppl:", train_ppl)
        print("Avg eval loss:", eval_loss)
        print("Avg eval acc:", eval_acc)
        print("Avg eval ppl:", eval_ppl)
        print(SEPERATOR)
        print("")
        ...
        if not args.no_tensorboard:
            ...
            tensorboard_summary.add_scalar(
                "Perplexity/train", train_ppl, global_step=epoch + 1
            )
            tensorboard_summary.add_scalar(
                "Perplexity/eval", eval_ppl, global_step=epoch + 1
            )
            tensorboard_summary.add_scalar(
