...
def parse_train_args():
    ...
    parser.add_argument(
        ...
        help="Folder of preprocessed and pickled midi files",
    )
    parser.add_argument(
        "-output_dir",
        type=str,
        default="./saved_models",
        help="Folder to save model weights. Saves one every epoch",
    )
    parser.add_argument(
        "-weight_modulus",
        type=int,
    ...
    parser.add_argument(
        "-n_workers", type=int, default=1, help="Number of threads for the dataloader"
    )
    parser.add_argument(
        "--force_cpu",
        action="store_true",
    ...
    parser.add_argument(
        "-epochs", type=int, default=100, help="Number of epochs to use"
    )
    ...
    parser.add_argument(
        "-n_layers", type=int, default=6, help="Number of decoder layers to use"
    )
    parser.add_argument(
        "-num_heads",
        type=int,
...
def parse_eval_args():
    ...
    parser.add_argument(
        "-model_weights",
        type=str,
        default="./saved_models/model.pickle",
